...
const TabsNavigator = () => {
  return (
    ...
    >
      ...
      />
          <BottomTabs.Screen name="Test-tab" component={TestNavigator}
            options={{
              tabBarIcon: ({ focused }) => (
                <View style={styles.tabBarIcon}>
                  <Ionicons name="images-outline" size={24} color={focused ? '#7F5DF0' : '#748C94'} />
                  <Text style={{ color: focused ? '#7F5DF0' : '#748C94' }}>Imagenes</Text>
                </View>
              )
            }}
            />
